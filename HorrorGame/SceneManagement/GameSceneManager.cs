...
namespace devtimezombie
{
    public class GameSceneManager : BaseSceneManager
    {
        ...
        public SceneFileReferences LevelSceneAsset;
        ...
        */
        ...
        public override void LoadLevelByName(string levelName)
        {
            CurrentScene = ValidateScene(LevelSceneAsset.sceneReferences[levelName]);
            if (!LevelSceneAsset.HasLoadScreen)
                base.LoadLevelByName(CurrentScene.SceneName);
            else
